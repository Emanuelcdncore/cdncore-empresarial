  ...
  useEffect(() => {
    ...
    class MouseClass {
      constructor() {
        ...
        this.takeoverDuration = 0.25; this.takeoverFrom = new THREE.Vector2(); this.takeoverTo = new THREE.Vector2();
    ...
    class Viscous extends ShaderPass {
      ...
      update({ viscous, iterations, dt }) {
        ...
        for (let i = 0; i < iterations; i++) {
          ...
          this.uniforms.velocity_new.value = fbo_in.texture; this.props.output = fbo_out; this.uniforms.dt.value = dt;
          super.update();
        }
        return fbo_out;
      }
    ...
    const io = new IntersectionObserver(entries => {
      ...
      visible && !document.hidden ? webglRef.current.start() : webglRef.current.pause();
